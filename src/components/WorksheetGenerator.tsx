...
export default function WorksheetGenerator({ onBack, studentName = 'مكتشف النور الصغير', favorites = [] }: WorksheetGeneratorProps) {
  ...
  const getQuestionsForPage = (pageIndex: number) => {
    ...
    // Build question arrays based on active lessons, incorporating specific curriculum contents
    // True/False pool (الصح والخطأ)
    const tfPool = [
      { q: "النية بالقلب تعد من فرائض الوضوء السبعة لتمام صحة الطهارة.", a: true, hint: "النية تجب للتمييز" },
      { q: "الملائكة الكرام مخلوقون من نور طاهر، وهم معصومون لا يعصون الله أبداً.", a: true, hint: "مخلوقات نورانية" },
      { q: "يصح الوضوء بالماء إذا خالطه حليب كثير حتى لم يعد يسمى ماءً لونه زكي.", a: false, hint: "يفقد صفة التطهير" },
      { q: "عند مغادرتنا لدورة المياه نقدم رجلنا اليسرى تيمناً وتكريماً.", a: false, hint: "نخرج بالرجل اليمنى" },
      { q: "نهانا نبينا الكريم عن قضاء الحاجة في ظِلال الناس أو في طريقهم وممشاهم صيانة لهم.", a: true, hint: "أدب إسلامي رقيق" },
      { q: "الصدق خلق نبوي كريم يشرق بالخير ويهدي صاحبه إلى البر ومن ثم الجنان الفسيحة.", a: true, hint: "الصدق منجاه وعماد" },
      { q: "الملك إسرافيل عليه السلام هو الملك الكريم الموكل بإنزال المطر والماء العذب وسقي العباد.", a: false, hint: "ميكائيل هو الموكل بالقطر" },
      { q: "بر الوالدين وابتغاء مرضاتهم يعد من أعظم الطاعات والقربات الموصلة للفردوس بعد توحيد الله.", a: true, hint: "رضا الله في رضا الوالدين" },
      { q: "المسلم الصغير المتميز ينظف بدنه وثيابه فوراً وبشكل دوري ليقف مبهجاً طاهراً في صلاته.", a: true, hint: "الطهارة شطر الإيمان" },
      { q: "نزل الوحي الإلهي الأول على نبينا محمد صلى الله عليه وسلم في غار ثور المبارك بمكة.", a: false, hint: "بدأ الوحي بغار حراء الشامخ" },
      { q: "استمرت الدعوة الإسلامية بمكة المكرمة في مرحلتها السرية لمدة ثلاث سنوات لبناء الرعيل الأول.", a: true, hint: "التحرك الفطن السري" },
      { q: "يجب على الطالب تبجيل المعلم واحترامه والإنصات إليه بعناية لأن من علمني حرفاً صرت له محباً.", a: true, hint: "قم للمعلم وفه التبجيلا" },
      { q: "الماء الطهور هو كل ماء نزل من السماء أو نبع من الأرض باق على طبيعته دون تغير.", a: true, hint: "مثل ماء الآبار والأمطار" },
      { q: "سورة التكاثر تذكرنا وتحذرنا من الانشغال بمتاع الحياة الفاني والتفاخر بالأموال عن طاعة الله.", a: true, hint: "ألهاكم التكاثر" },
      { q: "الرحمة بالصغير من الأخلاق والآداب الرفيعة التي حثنا عليها نبينا لنكون مجتمعاً دافئاً متضامناً.", a: true, hint: "ليس منا من لم يرحم صغيرنا" },
      { q: "التعاون بين الزملاء يورث البغضاء ويقلل من جودة وصحة الإنجاز داخل المدرسة.", a: false, hint: "التعاون يثمر المحبة والبركة" },
      { q: "حق الطريق يقتضي كف الأذى عن العابرين، وإفشاء السلام، والأمر بالمعروف بجهد وافر.", a: true, hint: "غض البصر وإرشاد الحائر" },
      { q: "سورة القارعة تصور مشاهد كونية مهيبة من زلازل القيامة الكبرى كالفراش المبثوث والعهن المنفوش.", a: true, hint: "كفة الحساب وثقل الموازين" },
      { q: "البارئ من أسماء الله الحسنى، ومعناه الذي يعطي لكل مخلوق صورته الفريدة وشكله الخارجي.", a: false, hint: "المصور هو الذي يصور الأشكال" },
      { q: "كان الصحابي الجليل أبو بكر الصديق واليسير من الأوائل الأبطال الذين آمنوا بالدعوة السرية بمكة.", a: true, hint: "أول من آمن من الرجال بطل العزم" }
    ];

    // MCQs Pool (الاختيار من متعدد)
    const mcqPool = [
      {
        q: "الملك الكريم الموكل بتبليغ ونزول الوحي السماوي من الله عز وجل على سائر الأنبياء هو:",
        opts: ["جبريل عليه السلام", "ميكائيل عليه السلام", "إسرافيل عليه السلام", "مالك خازن النار"],
        ans: 0
      },
      {
        q: "الماء النجس الذي تغير لونه أو طعمه أو رائحته بأوساخ ومياه صرف وبول مستقذر، حكمه:",
        opts: ["يصح الوضوء به مجبراً", "لا يجوز مطلقاً استعماله حفاظاً على طهارتنا وصحتنا", "يستحب غسل الثياب به فقط", "مكروه مع جواز الشرب"],
        ans: 1
      },
      {
        q: "عند خروجنا السعيد والمعافى من دورة المياه، يسن للمسلم الصغير تقديم رجله:",
        opts: ["اليسرى قائلاً: بسم الله", "اليمنى قائلاً: غفرانَك", "اليسرى قائلاً: الحمد لله", "رجليه معاً بوثبة"],
        ans: 1
      },
      {
        q: "كم فرصة وسنة مباركة نغتنمها لتكامل روح الوضوء، مثل المضمضة والاستنشاق وغسل الكوعين؟",
        opts: ["سنن الوضوء العطرة", "فرائض الوضوء السبعة", "مبطلات الوضوء الطارئة", "نواقض الصلاة الكبرى"],
        ans: 0
      },
      {
        q: "تلقى نبينا الحبيب محمد صلى الله عليه وسلم كلمة الوحي الأولى الإلهية (اقرأ) في رحاب غار صامد هو:",
        opts: ["غار ثور المبارك", "غار حراء الشامخ بقمة جبل النور", "شعب أبي طالب", "جبل الصفا بمكة"],
        ans: 1
      },
      {
        q: "أي الذرات كفة ميزان العباد يوم القيامة التي تزن الأعمال بدقة متناهية يوم الزلزلة والبعث؟",
        opts: ["ميزان الذر الدقيق الدائم (فمن يعمل مثقال ذرة)", "ميزان الأجسام المادية الكبيرة", "توزيع الأموال الدنيوية فقط", "تفاخر العائلات بالألقاب"],
        ans: 0
      },
      {
        q: "خلق الصدق يحمي عقولنا، ومن أهم مكارم الأخلاق والفضائل التي تهدي الفرد والمسلمين جميعاً إلى:",
        opts: ["الخسارة والندم السريع", "البر الصالح ومن ثم جنان الرحمن ونوره", "التكاثر الملهي المغفِل", "التواكل والنوم المستمر"],
        ans: 1
      },
      {
        q: "البارئ من أسماء الله العظيمة والمباركة، ويعني في لغة العقيدة والتوحيد السليم:",
        opts: ["الذي أوجد وخلق الأجسام سالمة بغير عيوب أو تفاوت بليغ", "الذي يطوي السموات بيمينه", "الذي يرزق النبات ماءً مالحاً", "الذي يعاقب المخالفين بالنيران"],
        ans: 0
      },
      {
        q: "من آداب الطريق المسؤولة والنبيلة التي وصانا بها نبينا الكريم لسلامة جميع العابرين:",
        opts: ["إلقاء القمامة في وسط الطريق", "اللعب بالكرة المزعجة وسط المارة", "كف الأذى، وغض البصر، وإفشاء السلام المحب", "التحدث بصوت مرتفع ساخر"],
        ans: 2
      },
      {
        q: "كان الصحابة الأجلاء يجتمعون سراً في مستهل الدعوة والتحرك الفطن بدار نموذجية هي:",
        opts: ["دار الندوة العائلية الكبرى", "دار الأرقم بن أبي الأرقم لتلاوة القرآن والآداب", "دار أبي لهب بمكة المكرمة", "شعب بني هاشم المعزول"],
        ans: 1
      }
    ];
    ...
    const fillPool = [
      { q: "نحيي بعضنا إفشاءً للسلام والمحبة بتمام قولنا: ....................................... .", a: "السلام عليكم ورحمة الله وبركاته" },
      { q: "من الصحف الأولى التي ذكرها الله بمستهل سورة الأعلى صحف ....................................... وموسى.", a: "إبراهيم" },
      { q: "الرحمة هي خلق عظيم، والراحمون في الدنيا يرحمهم الله تبارك وتعالى ....................................... .", a: "الرحمن" },
      { q: "ندخل لدورة المياه مستغيثين ومتحصنين بالقدم ....................................... .", a: "اليسرى" },
      { q: "الماء ....................................... هو الماء الباقي على طبيعته كأصله ويصح به التطهير والوضوء والطبخ.", a: "الطهور" },
      { q: "مبطلات الوضوء الطارئة التي تزيل طهارتنا ونقائنا تسمى ....................................... .", a: "نواقض الوضوء (الخارج من السبيلين والنوم العميق)" },
      { q: "الملك الموكل بإنزال القطر العذب والرياح وإحياء الزرع بأمر ربه هو الملك ....................................... .", a: "ميكائيل عليه السلام" },
      { q: "أول من آمن بدعوة نبينا من النساء والزوجات هي السيدة الفاضلة والصبورة ....................................... .", a: "خديجة بنت خويلد رضي الله عنها" },
      { q: "دعا رسولنا الجليع قوم قريش جهراً بالحق والصدق صاعداً فوق جبل ....................................... بمكة العريقة.", a: "الصفا" },
      { q: "من مكارم السلوك تبجيل وصون المعلم في فصلي ومدرستي المضيئة لأن المعلم هو ....................................... .", a: "مربي الأجيال ومصدر النور والعلم" }
    ];

    // Odd one out Pool (الكلمة الشاذة)
    const oddPool = [
      { items: ["مياه مائية عذبة", "مياه الأمطار الساقطة", "الحليب والعصير الطازج", "مياه الآبار الجارية"], odd: "الحليب والعصير الطازج", reason: "لأنهما طاهران في أنفسهما ولكن غير مطهرين للوضوء، بينما البقية مياه طهورة مطلقة." },
      { items: ["الملك جبريل عليه السلام", "إبليس اللعين المطرود", "الملك ميكائيل عليه السلام", "الملك إسرافيل عليه السلام"], odd: "إبليس اللعين المطرود", reason: "لأنه من الجن العاصين وليس من الملائكة الكرام المعصومين المطيعين للرحمن." },
      { items: ["النية في القلب", "غسل الوجه كاملاً", "مسح الأذنين برفق", "غسل اليدين للمرفقين"], odd: "مسح الأذنين برفق", reason: "لأن مسح الأذنين يعد من سنن ومستحبات الوضوء، بينما البقية من الفرائض السبعة التي لا يصح الوضوء بدونها." },
      { items: ["الصدق في الحديث", "الأمانة في التعامل", "الكذب والخيانة والزور", "التعاون ومحبة الخير"], odd: "الكذب والخيانة والزور", reason: "لأنها رذائل وأخلاق منبوذة تدنس نماء القلب، بينما البقية من مكارم الفضائل الإيجابية الشاهقة." },
      { items: ["سورة التكاثر الكريمة", "سورة القارعة المهيبة", "قصة أصحاب الأخدود التاريخية", "سورة الزلزلة العظيمة"], odd: "قصة أصحاب الأخدود التاريخية", reason: "لأن البقية سور قرآنية كاملة مخصصة للحفظ والتدبر في منهج التلاوة والقرآن للصف الثالث الابتدائي، بينها قصة تاريخية." }
    ];

    // Column Match Pool (القوائم المتقابلة)
    const matchPool = [
      { a: "الخالق البديع جل شأنه", b: "هو الذي أوجد وأبدع سائر المخلوقات والكون العظيم من عدم وهداها بميزان." },
      { a: "البارئ القدير الشافي", b: "هو الذي خلق الأجسام المادية ونظّم حركتها سليمة نقية خالية من العيوب والتفاوت." },
      { a: "المصور المهيمن الجلي", b: "هو الذي وصم وصوّر سائر الخليقة بملامحها وهيئاتها وألوانها الباهرة الجميلة." },
      { a: "بر الوالدين الأوفياء", b: "أفضل دأب وطاعة تلي عبادة التوحيد، وهي مدخل المسلم المفتوح لنيل ثواب جنة نعيم." },
      { a: "الصدق والأمانة والبر", b: "أشرف مساعي وعماد الفرد الفاضل تهدي الصغير للطمأنينة وللخير الوفير وصادق القول." }
    ];

    // Definitions / Essay Pool (التعريفات والتعليلات)
    const essayPool = [
      { q: "عرّف بأسلوبك البطل الصالح مفهوم (الماء الطهور) المعتمد في طهارتنا اليومية؟", space: "...................................................................................................................................................................." },
      { q: "علّل بذكر حكمة نبوية رقيقة: كف الأذى وإماطة العوائق والقمامة عن الطريق العام وحقوق المارة؟", space: "...................................................................................................................................................................." },
      { q: "ما هي الحكمة العميقة المباركة من اتخاذ النبي صلى الله عليه وسلم لدار الأرقم سراً بمستهل دعوته؟", space: "...................................................................................................................................................................." },
      { q: "عرف مفهوم (الصدق) ولماذا حثنا عليه رسولنا الأمين صلى الله عليه وسلم في سائر شؤون الحوار؟", space: "...................................................................................................................................................................." },
      { q: "علل لما يأتي: نهى الإسلام نهياً قاطعاً عن قضاء الحاجة في مجاري المياه النقية وظلال الأشجار المثمرة؟", space: "...................................................................................................................................................................." }
    ];
